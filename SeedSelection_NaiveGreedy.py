...
class SeedSelection_NG:
    ...
    def updateExpectProfitList(self, s_set, nb_seed_set, ep_list, cur_budget, a_n_set, w_list, pp_list):
        ...
        for k in range(self.num_product):
            for i in nb_seed_set[k]:
                ep_list[k][int(i)] = dnic.getSeedExpectProfit(k, i, s_set, a_n_set[k], w_list, pp_list[k])
...
if __name__ == "__main__":
    ...
    while now_budget < total_budget and mep_i_node != '-1':
        ...
        exp_profit_list, nban_seed_set = ssng.updateExpectProfitList(seed_set, nban_seed_set, exp_profit_list, now_budget, activated_node_set,
